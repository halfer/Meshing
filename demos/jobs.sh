...
# Add new connections
./meshing connection:add --name jobs_conn_1 --adaptor pgsql --database db_jobs_1 --host localhost --user jon
./meshing connection:add --name jobs_conn_2 --adaptor pgsql --database db_jobs_2 --host localhost --user jon
