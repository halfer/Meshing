...
/**
 * This class defines the structure of the 'meshing_schema' table.
 *
 *
 *
 ...
 */
class MeshingSchemaTableMap extends TableMap
{

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'system.map.MeshingSchemaTableMap';
	...
	{
		// attributes
		$this->setName('meshing_schema');
		$this->setPhpName('MeshingSchema');
		$this->setClassname('MeshingSchema');
		$this->setPackage('system');
		$this->setUseIdGenerator(true);
		$this->setPrimaryKeyMethodInfo('meshing_schema_id_seq');
		// columns
	...
	public function buildRelations()
	{
		...
		$this->addRelation('MeshingSchemaTable', 'MeshingSchemaTable', RelationMap::ONE_TO_MANY, array('id' => 'schema_id', ), null, null);
	} // buildRelations()

} // MeshingSchemaTableMap
